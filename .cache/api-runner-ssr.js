var plugins = [{
      plugin: require('C:/www/virtualGroundsSeries/node_modules/gatsby-plugin-react-helmet/gatsby-ssr'),
      options: {"plugins":[]},
    },{
      plugin: require('C:/www/virtualGroundsSeries/node_modules/gatsby-plugin-google-analytics/gatsby-ssr'),
      options: {"plugins":[],"head":false,"anonymize":false,"respectDNT":false,"exclude":[],"pageTransitionDelay":0},
    },{
      plugin: require('C:/www/virtualGroundsSeries/node_modules/gatsby-plugin-manifest/gatsby-ssr'),
      ...
      plugin: require('C:/www/virtualGroundsSeries/node_modules/gatsby-plugin-offline/gatsby-ssr'),
      options: {"plugins":[]},
    }]
